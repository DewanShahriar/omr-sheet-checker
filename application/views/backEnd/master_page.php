        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="<?php echo base_url(); ?>" class="logo">
                    ...
                    <span class="logo-mini"><b>HR</b>SOFT </span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>HR</b>Service</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php if ($activeMenu === "exam_add" || $activeMenu === "exam_list" || $activeMenu === "exam_edit") echo "active"; ?> ">
                            <a href="#">
                            <i class="fa fa-newspaper-o"></i> <span> <?php echo $this->lang->line("exam"); ?> </span>
                            <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                            </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class=" <?php if ($activeMenu === "exam_add") echo "active"; ?> "><a href="<?php echo base_url('admin/exam/add'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line("exam_add"); ?> </a></li>
                                <li class=" <?php if ($activeMenu === "exam_list") echo "active"; ?> "><a href="<?php echo base_url('admin/exam/list'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line("exam_list"); ?> </a></li>
                            </ul>
                        </li>
