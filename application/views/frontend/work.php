    ...
    <section class="header-inner header-inner-menu bg-overlay-black-30" style="background-image: url('<?= base_url()?>front_end_assets/images/header-inner/09.jpg');">
          ...
          <div class="row">
            ...
            <div class="col-12 d-flex justify-content-center">
              ...
              <ul class="nav">
                ...
                <li class="nav-item"><a class="nav-link active" href="<?= base_url()?>site/work">How we work</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 mb-4 mb-sm-0">
            ...
            <img class="img-fluid border-radius" src="<?= base_url()?>front_end_assets/images/about/10.jpg" alt="">

          </div>

          <div class="col-sm-6">

            <img class="img-fluid border-radius" src="<?= base_url()?>front_end_assets/images/about/11.jpg" alt="">
        ...
        <div class="row">
          ...
          <div class="col-md-4 pb-4 pb-md-0">
            ...
            <div class="pricing">
              ...
              <a href="#" class="btn btn-light-round btn-round">Select Plan<i class="fas fa-arrow-right pl-3"></i></a>
