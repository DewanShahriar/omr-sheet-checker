      ...
      <div class="swiper-container">
        <div class="swiper-wrapper h-700 h-sm-500">
          <?php foreach ($slider as $key => $value) {?>
            <div class="swiper-slide align-items-center d-flex responsive-overlap-md bg-overlay-black-30" style="background-image:url(<?= base_url($value->photo)?>); background-size: cover; background-position: center center;">
            <div class="swipeinner container">
              <div class="row justify-content-center">
                <div class="col-lg-9 col-md-10 text-center">
                  <h1 data-swiper-animation="fadeInUp" data-duration="1s" data-delay="0.25s"><?= $value->title?></h1>
                  <h6 data-swiper-animation="fadeInUp" data-duration="1s" data-delay="0.5s"><?= $value->sub_title?></h6>
          ...
          <div class="col-sm-12">
            <div class="our-clients our-clients-style-02 bg-dark">
              ...
              <div class="brand-logo pl-4">
                <div class="owl-carousel testimonial-center owl-nav-bottom-center" data-nav-arrow="false" data-items="5" data-md-items="4" data-sm-items="4" data-xs-items="3" data-xx-items="2" data-space="40" data-autoheight="true">
                  ...
                  <?php foreach ($client as $key => $value) {?>
                    <div class="item">
                    <img class="img-fluid center-block mx-auto" src="<?= base_url($value->logo)?>" alt="">
                  </div>
                  <?php }?>
              ...
              <div class="client-btn">
                <a href="#" class="btn btn-primary-round btn-round text-white">Case Studies<i class="fas fa-arrow-right pl-3"></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 d-md-flex justify-content-center align-items-center">
            ...
            <a href="#" class="btn btn-primary-round btn-round mx-0 mx-md-3">Get A Quote<i class="fas fa-arrow-right pl-3"></i></a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 order-lg-1 order-1">
            <div class="case-study">
              <div class="case-study-img case-study-lg" style="background-image: url('<?= base_url()?>front_end_assets/images/project/02.jpg');">
              </div>
          ...
          <div class="col-md-12 col-lg-4 order-lg-2 order-3">
            <div class="row">
              <div class="col-sm-6 col-lg-12">
                <div class="case-study">
                  <div class="case-study-img" style="background-image: url('<?= base_url()?>front_end_assets/images/project/04.jpg');">
                  </div>
                  <div class="case-study-info">
              ...
              <div class="col-sm-6 col-lg-12">
                <div class="case-study">
                  <div class="case-study-img" style="background-image: url('<?= base_url()?>front_end_assets/images/project/06.jpg');">
                  </div>
                  <div class="case-study-info">
          ...
          <div class="col-md-6 col-lg-4 order-lg-3 order-2">
            <div class="case-study">
              <div class="case-study-img case-study-lg" style="background-image: url('<?= base_url()?>front_end_assets/images/project/05.jpg');">
              </div>
              <div class="case-study-info">
        ...
        <div class="row">
          <div class="col-12 d-flex justify-content-center mt-0 mt-md-4">
            <a href="#" class="btn btn-primary-round btn-round mx-3">View all Case Study<i class="fas fa-arrow-right pl-3"></i></a>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-3">
            <div class="d-flex h-100">
              <div class="nav flex-column nav-pills w-100 align-self-lg-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#technology-partners" role="tab" aria-controls="technology-partners" aria-selected="false"><span class="data-hover" data-title="Technology partners">Technology partners</span></a>
          ...
          <div class="col-md-9 mt-3 mt-md-0">
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade" id="mission-and-vision" role="tabpanel" aria-labelledby="mission-and-vision-tab">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="<?= base_url()?>front_end_assets/images/about/01.jpg" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center pl-md-0 pl-lg-5">
                    <h4><i class="flaticon-target text-primary mr-2"></i> <?php echo $shortcut_info['our_mission']->title;?></h4>
                    <p class="mb-4"><?php echo $shortcut_info['our_mission']->value;?> </p>
                    <h4><i class="flaticon-eye text-primary mr-2"></i> <?php echo $shortcut_info['our_vision']->title;?></h4>
                    <p class="mb-4"><?php echo $shortcut_info['our_vision']->value;?> </p>
                    <h6 class="font-weight-normal text-muted mt-4">Our Vision and Mission are both encouraging our team to accomplish the goal. We recognize the clients' requirements, analyze them, and provide the best solutions. We satisfy our clients by our services and implements it with more capable software solution approaches.</h6>
                  </div>
                </div>
              </div>
              <div class="tab-pane  fade show active" id="our-challenges" role="tabpanel" aria-labelledby="our-challenges-tab">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="<?= base_url()?>front_end_assets/images/about/04.jpg" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center pl-md-0 pl-lg-5">
                    ...
                    <p class="d-flex align-items-center mb-4">
                      <span class="font-weight-bold text-dark mr-2">Alice Williams</span> -
                      <label class="ml-2 mb-0">Sales and Marketing</label>
                    </p>
              ...
              <div class="tab-pane fade" id="technology-partners" role="tabpanel">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="<?= base_url()?>front_end_assets/images/about/03.jpg" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center pl-md-0 pl-lg-5">
                    ...
                    <div class="row">
                      <?php foreach ($client as $key => $value) {?>
                        ...
                        <img class="img-fluid grayscale p-2" src="<?= base_url($value->logo)?>" alt="">
                      </div>
              ...
              <div class="tab-pane fade" id="meet-the-our-team" role="tabpanel" aria-labelledby="meet-the-our-team-tab">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="<?= base_url()?>front_end_assets/images/about/02.jpg" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center pl-md-0 pl-lg-5">
                    <div class="row">
              ...
              <div class="tab-pane fade" id="careers-with-us" role="tabpanel" aria-labelledby="careers-with-us-tab">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="<?= base_url()?>front_end_assets/images/about/07.jpg" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center pl-md-0 pl-lg-5">
                    ...
                    <div class="row mb-4">
                      <div class="col-md-6">
                        <ul class="list list-unstyled">
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Flexible Time Off </span></li>
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>24/7 parking. </span></li>
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Full medical benefits </span></li>
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Pto / vacation</span></li>
                        </ul>
                      </div>
                      <div class="col-md-6">
                        <ul class="list list-unstyled">
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Flexible hours</span></li>
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Collaborative environment</span></li>
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Health, Dental, And Vision</span></li>
                          <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Collaborative environment</span></li>
                        </ul>
                      </div>
                    </div>
                    <a href="#" class="btn btn-primary-round btn-round mt-2">View Available Positions<i class="fas fa-arrow-right pl-3"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title is-sticky">
              ...
              <a href="#" class="btn btn-primary-round btn-round">See All Services<i class="fas fa-arrow-right pl-3"></i></a>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
        ...
        <div class="row mb-0 mb-lg-4">
            ...
            <div class="owl-carousel testimonial-style-02" data-nav-arrow="true" data-nav-dots="false" data-items="1" data-lg-items="1" data-md-items="1" data-sm-items="1" data-space="0" data-autoheight="true">
              <?php foreach ($testimonial as $key => $value) {?>
                ...
                <div class="video-image">
                  <img class="img-fluid w-100" src="<?= base_url($value->background_photo)?>" alt="">
                </div>
                <div class="testimonial-item">
                  <div class="testimonial-avatar">
                    <img class="img-fluid rounded-circle" src="<?= base_url($value->photo)?>" alt="">
                  </div>
          ...
          <div class="col-lg-6 col-xl-5 align-self-center pl-0 pl-lg-5 mt-5 mt-lg-0">
            <div class="pl-3 pl-lg-4">
              ...
              <a href="#" class="btn btn-primary-round btn-round mb-3">Client Success Stories<i class="fas fa-arrow-right pl-3"></i></a>
              <hr class="pb-3">
              <h5 class="text-primary mt-md-4 mt-lg-5 mb-3">Awards and Nominees</h5>
              <div class="row">
                <div class="col-lg-6 col-sm-3 col-6 mb-3 mb-md-0"><img class="img-fluid grayscale pt-4 w-75" src="<?= base_url()?>front_end_assets/images/award-logo/01.svg" alt=""></div>
                <div class="col-lg-6 col-sm-3 col-6 mb-3 mb-md-0"><img class="img-fluid grayscale pt-4 w-75" src="<?= base_url()?>front_end_assets/images/award-logo/05.svg" alt=""></div>
                <div class="col-lg-6 col-sm-3 col-6 "><img class="img-fluid grayscale pt-4 pt-lg-5 w-75" src="<?= base_url()?>front_end_assets/images/award-logo/03.svg" alt=""></div>
                <div class="col-lg-6 col-sm-3 col-6 "><img class="img-fluid grayscale pt-4 pt-lg-5 w-75" src="<?= base_url()?>front_end_assets/images/award-logo/04.svg" alt=""></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-7 col-lg-8 mb-4">
            <div class="blog-post blog-post-sticky">
              <div class="blog-post-image">
                <img class="img-fluid" src="<?= base_url()?>front_end_assets/images/blog/01.jpg" alt="">
              </div>
          ...
          <div class="col-md-5 col-lg-4">
            <div class="blog-post mb-4">
              <div class="blog-post-image">
                <img class="img-fluid" src="<?= base_url()?>front_end_assets/images/blog/02.jpg" alt="">
              </div>
              <div class="blog-post-content">
                <div class="blog-post-info">
                  <div class="blog-post-author">
            ...
            <div class="blog-post mb-4">
              <div class="blog-post-image">
                <img class="img-fluid" src="<?= base_url()?>front_end_assets/images/blog/03.jpg" alt="">
              </div>
              <div class="blog-post-content">
                <div class="blog-post-info">
                  <div class="blog-post-author">
...
<!--=================================
  Client Logo -->
<section class="py-5 mb-5 our-clients bg-dark">
  <div class="container-fluid">
    <div class="row align-items-center justify-content-center">
      <div class="col-xl-12 col-md-12">
        <div class="owl-carousel" data-nav-arrow="false" data-items="8" data-md-items="4" data-sm-items="4" data-xs-items="3" data-xx-items="2" data-space="40" data-autoheight="false">
          <div class="item">
            <img class="" src="<?= base_url()?>front_end_assets/images/award-logo/atab.png" alt="">
          </div>
          <div class="item">
            <img class="" src="<?= base_url()?>front_end_assets/images/award-logo/focus.png" alt="">
          </div>
          <div class="item">
            <img class="grayscale" src="<?= base_url()?>front_end_assets/images/award-logo/bonpa.png" alt="">
          </div>
          <div class="item">
            <img class="" src="<?= base_url()?>front_end_assets/images/award-logo/pwd.png" alt="">
          </div>
          <div class="item">
            <img class="" src="<?= base_url()?>front_end_assets/images/award-logo/ucc.png" alt="">
          </div>
          <div class="item">
            <img class="" src="<?= base_url()?>front_end_assets/images/award-logo/haab.png" alt="">
          </div>
        </div>
      </div>
    </div>
