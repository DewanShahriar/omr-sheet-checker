    ...
    <div class="row d-flex justify-content-center">
      <div class="col-md-12">
        <div class="header-inner-title text-center">
          <h1 class="text-white font-weight-normal mb-0"><?= $expertise_info->title?></h1>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="blog-detail">
          <div class="blog-post mb-4 mb-md-5">
            <div class="blog-post-image">
              <img class="img-fluid" src="<?= base_url($expertise_info->photo)?>" alt="">
            </div>
            <div class="blog-post-content">
              <div class="blog-post-info">
                <div class="blog-post-author">
                  <a href="<?= base_url()?>site/blog" class="btn btn-light-round btn-round text-primary"><?= str_replace("**",",", $expertise_info->category);?></a>
                </div>
                <!-- <div class="blog-post-date">
                  <a href="#"><?= date('M d, Y', strtotime($expertise_info->publish_date))?></a>
                </div> -->
              </div>
              <div class="blog-post-details">
                <h5 class="blog-post-title">
                  <?= $expertise_info->title?>
                </h5>
                <?= $expertise_info->description?>
                <?php if($expertise_info->quote){?>
                <div class="d-sm-flex bg-light border-radius p-4 p-md-5 mb-md-5 mb-4">
                  <i class="fas fa-quote-left pr-4 fa-6x text-primary"></i>
                  <p class="mb-0 text-dark"><?= $expertise_info->quote?></p>
                </div>
              <?php }?>
                <ul class="list list-unstyled">
                  <?php
                  if($expertise_info->main_point){
                  $main_points = explode('**', $expertise_info->main_point);
          ...
          <div class="blog-post mb-4 mb-md-5">
            <?php if($expertise_info->video_link){?>
            <div class="blog-post-image position-relative">
              <iframe width="560" height="400" src="<?php echo $expertise_info->video_link;?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <?php }?>
            <div class="blog-post-content">
              <div class="blog-post-details">
