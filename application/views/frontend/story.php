    <!--=================================
    Header Inner -->
    <section class="header-inner header-inner-menu bg-overlay-black-30" style="background-image: url('<?= base_url();?>front_end_assets/images/header-inner/14.jpg');">
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-8">
            <div class="header-inner-title text-center">
              <h1 class="text-white font-weight-normal">Success Stories</h1>
          ...
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
              <ul class="nav">
                ...
                <li class="nav-item"><a class="nav-link active" href="<?= base_url()?>site/story">Success Stories</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="col-sm-6 mb-4 mb-sm-0">
            <div class="feature-info feature-info-style-02 bg-dark text-white">
              <div class="feature-info-icon">
                ...
                <h4 class="mb-0 ml-4 feature-info-title text-white"><?php echo $shortcut_info['our_vision']->title;?></h4>
              </div>
              <div class="feature-info-content">
                <p class="mb-0"><?php echo $shortcut_info['our_vision']->value;?></p>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="feature-info feature-info-style-02 bg-primary text-white">
              <div class="feature-info-icon">
                ...
                <h4 class="mb-0 ml-4 feature-info-title text-white"><?php echo $shortcut_info['our_mission']->title;?></h4>
              </div>
              <div class="feature-info-content">
                <p class="mb-0"><?php echo $shortcut_info['our_mission']->value;?></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container-fluid p-0">
        <div class="row no-gutters">
          <div class="col-sm-12">
            <img class="img-fluid" src="<?= base_url();?>front_end_assets/images/bg/07.png" alt="">
          </div>
        </div>
      </div>
    </section>
