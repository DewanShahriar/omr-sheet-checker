    <!--=================================
    Header Inner -->
    <section class="header-inner header-inner-menu bg-overlay-black-30" style="background-image: url('<?= base_url();?>front_end_assets/images/header-inner/16.jpg');">
      <div class="container">
          ...
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
              <ul class="nav">
                ...
                <li class="nav-item"><a class="nav-link active" href="<?= base_url()?>site/value">Our values</a></li>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="position-relative">
              <img class="img-fluid border-radius" src="<?= base_url();?>front_end_assets/images/blog/01.jpg" alt="">
