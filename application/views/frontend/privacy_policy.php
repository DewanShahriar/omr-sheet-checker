      ...
      <div class="container">
        <div class="row">
          ...
          <ul class="list-unstyled">
            <li class="mb-2"> <i class="fa fa-angle-right pr-2 mb-2"></i> Now go push your own limits and succeed!  </li>
            <li class="mb-2"> <i class="fa fa-angle-right pr-2 mb-2"></i> Success is something of which we all want more.</li>
            <li class="mb-2"> <i class="fa fa-angle-right pr-2 mb-2"></i> They’re wrong – it’s not!</li>
            <li class="mb-2"> <i class="fa fa-angle-right pr-2 mb-2"></i> Most people believe that success is difficult.</li>
            <li> <i class="fa fa-angle-right pr-2 mb-2"></i> There are basically six key areas to higher achievement</li>
          </ul>
          ...
          <ul class="list-unstyled">
            <li class="mb-2"> <i class="fa fa-angle-right pr-2 mb-2"></i> You will run aground and become hopelessly stuck in the mud.</li>
            <li class="mb-2"> <i class="fa fa-angle-right pr-2 mb-2"></i> You will drift aimlessly until you arrive back at the original dock.</li>
            <li class="mb-2"> <i class="fa fa-angle-right pr-2 mb-2"></i> Trying to go through life without clarity is similar to sailing. </li>
            <li> <i class="fa fa-angle-right pr-2 mb-2"></i> The sad thing is the majority of people.</li>
          </ul>
