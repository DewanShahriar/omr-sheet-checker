    ...
    <section class="header-inner bg-overlay-black-50" style="background-image: url('<?= base_url();?>front_end_assets/images/service/SchoolManagement/1.jpg');">
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-8">
            ...
            <div class="header-inner-title text-center">
              ...
              <h2 class="text-white font-weight-bold">School Management Software</h2>
          ...
          <div class="col-xl-10">
            ...
            <div class="service-details">
              ...
              <div class="custom_details text-center">
                 ...
                 <img class="img-fluid border-radius mb-4 mb-md-5" src="<?= base_url();?>front_end_assets/images/service/SchoolManagement/2.jpg" alt="">
              ...
              <div class="row mb-4 mb-md-5">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                     ...
                     <img class="img-fluid border-radius" src="<?= base_url();?>front_end_assets/images/service/SchoolManagement/3.gif" alt="">
