    <!--=================================
    Header Inner -->
    <section class="header-inner header-inner-menu bg-overlay-black-50" style="background-image: url('<?= base_url();?>front_end_assets/images/header-inner/12.jpg');">
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-8">
            <div class="header-inner-title text-center">
              <h1 class="text-white font-weight-normal">Construction</h1>
              <p class="text-white mb-0">One thing for certain though, is that irrespective of the number of steps the experts talk about, they all originate from the same roots.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!--=================================
    Category -->
    <section id="service-offerings" class="space-pt pb-4 pb-md-5">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
        ...
        <div class="row category category-grid-style-02">
          <div class="col-12">
            <ul class="list-unstyled">
              ...
              <li><a href="#">Tours & Travel Software</a></li>
              <li><a href="#">Industrial and Manufacturing</a></li>
    ...
    <section id="technology" class="space-ptb bg-light-half-md">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <!-- owl carousel -->
            <div class="owl-carousel owl-carouselstyle-02" data-nav-arrow="false" data-nav-dots="false" data-items="4" data-lg-items="3" data-md-items="3" data-sm-items="2" data-space="30" data-autoheight="true">
              <div class="item">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="section-title is-sticky">
              <h2 class="text-white">Smart strategy & excellent performance</h2>
              <p class="text-white mb-4 mb-md-5">Process that guarantees high productivity and profitability for your solution.</p>
              <a href="#" class="btn btn-primary-round btn-round text-white">Let's Start Project<i class="fas fa-arrow-right pl-3"></i></a>
            </div>
          </div>
          <div class="col-md-6">
              ...
              <div class="feature-info-inner">
                <div class="feature-info-item">
                  ...
                  <div class="feature-info-content">
                    <h5 class="mb-3 feature-info-title text-white">Analysis</h5>
                ...
                <div class="feature-info-item">
                  ...
                  <div class="feature-info-content">
                    <h5 class="mb-3 feature-info-title text-white">Design</h5>
                ...
                <div class="feature-info-item">
                  ...
                  <div class="feature-info-content">
                    <h5 class="mb-3 feature-info-title text-white">Development</h5>
                ...
                <div class="feature-info-item">
                  ...
                  <div class="feature-info-content">
                    <h5 class="mb-3 feature-info-title text-white">Testing</h5>
                ...
                <div class="feature-info-item">
                  ...
                  <div class="feature-info-content">
                    <h5 class="mb-3 feature-info-title text-white">Go-Live</h5>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="section-title">
              ...
              <p>This is the first step of the process! Key: Notice how you felt excited and optimistic when you did this? The reason is simple.</p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-5 pr-lg-5 mb-4 mb-md-0">
            ...
            <div class="border-bottom">
              ...
              <h6 class="text-light font-weight-normal">Award-winning website design & creative digital agency services</h6>
            </div>
          </div>
          <div class="col-md-7 pl-lg-5">
            <div class="mb-4 mb-sm-0">
              <h6 class="mb-0 text-dark">The first thing to remember about success is that it is a process – nothing more, nothing less. There is really no magic to it and it’s not reserved only for a select few people. As such, success really has nothing to do with luck, coincidence or fate. It really comes down to understanding.</h6>
            </div>
            <div class="row mt-4 mt-md-5">
              <div class="col-md-6 mb-3">
                <ul class="list list-unstyled ckeck-list">
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Having clarity of purpose</span></li>
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>We know that the Law</span></li>
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>We will attract confusion</span></li>
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>The sad thing is the majority</span></li>
                </ul>
              </div>
              <div class="col-md-6">
                <ul class="list list-unstyled ckeck-list">
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>What do I really want? What does success</span></li>
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>Why do I want a particular thing</span></li>
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>How will this achievement change my life</span></li>
                  <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span>How can I use this success to make</span></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="owl-carousel text-left" data-nav-dots="true" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="1" data-xx-items="1">
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg" style="background-image: url('<?= base_url();?>front_end_assets/images/project/03.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">The Sports Space</a>
                    <span class="case-study-services text-white">Sports</span>
                    <p class="mt-2">The first thing to remember about success is that it is a process…</p>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/04.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Educatgenix</a>
                    <span class="case-study-services text-white">Education</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/05.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Financeoont</a>
                    <span class="case-study-services text-white">Finance</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/12.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Healthque</a>
                    <span class="case-study-services text-white">Health</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/08.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Travelomatic</a>
                    <span class="case-study-services text-white">Traveling</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/09.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Mobifluent</a>
                    <span class="case-study-services text-white">Mobile</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/11.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Dentzoid</a>
                    <span class="case-study-services text-white">Dental</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/02.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Gozzby</a>
                    <span class="case-study-services text-white">Music</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/10.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Foodocity</a>
                    <span class="case-study-services text-white">Food</span>
              ...
              <div class="items">
                <div class="case-study case-study-style-02">
                  <div class="case-study-img case-study-lg bg-holder" style="background-image: url('<?= base_url();?>front_end_assets/images/project/06.jpg');">
                  </div>
                  <div class="case-study-info">
                    <a class="case-study-title font-weight-bold" href="#">Petfluent</a>
                    <span class="case-study-services text-white">Pet Care</span>
